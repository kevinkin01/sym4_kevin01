...
class srcDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    private function doMatch(string $rawPathinfo, array &$allow = array(), array &$allowSchemes = array()): ?array
    {
        ...
        switch ($pathinfo) {
            default:
                $routes = array(
                    '/' => array(array('_route' => 'accueil', '_controller' => 'App\\Controller\\PublicController::index'), null, null, null),
        ...
        foreach ($regexList as $offset => $regex) {
            while (preg_match($regex, $matchedPathinfo, $matches)) {
                switch ($m = (int) $matches['MARK']) {
                    default:
                        $routes = array(
                            21 => array(array('_route' => 'detail_article', '_controller' => 'App\\Controller\\PublicController::oneArticle'), array('id'), null, null),
                            42 => array(array('_route' => 'detail_section', '_controller' => 'App\\Controller\\PublicController::oneSection'), array('id'), null, null),
